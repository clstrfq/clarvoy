...
export default function CreateDecision() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    create(values);
    // Navigation happens after success in the hook or user can navigate manually
    // For smoother UX, we can wait or redirect immediately if optimistic
    // But react-query handles onSuccess in the hook.
    // Let's rely on the user to go back or toast, but redirecting is standard for Create pages.
    setLocation("/");
  }
