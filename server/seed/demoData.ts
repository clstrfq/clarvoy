...
async function ensureDemoUsers() {
  const demoUsers = [
    { id: "demo_reviewer_1", firstName: "Dr. Sarah", lastName: "Chen", email: "sarah.chen@demo.clarvoy.org" },
    { id: "demo_reviewer_2", firstName: "Marcus", lastName: "Williams", email: "marcus.williams@demo.clarvoy.org" },
    { id: "demo_reviewer_3", firstName: "Elena", lastName: "Rodriguez", email: "elena.rodriguez@demo.clarvoy.org" },
  ];
...
const REFERENCE_CLASSES = [
  ...
  },
  {
    ...
    metrics: {
      n: 234,
      avg_transition_adjustment_months: 4.8,
      pct_temporary_became_permanent: 0.34,
      lifesharing_discontinuation_rate_18mo: 0.22,
      avg_behavioral_incidents_first_90_days: 3.7,
      pct_maintained_community_connections: 0.61,
      avg_annual_cost_group_home: 142000,
      avg_annual_cost_lifesharing: 68000,
    },
  },
  {
  ...
  },
  {
    ...
    metrics: {
      n: 89,
      states_with_sdm_legislation: 47,
      avg_pilot_duration_months: 18,
      pct_participants_reporting_improved_autonomy: 0.84,
      pct_guardians_reporting_comfort_post_pilot: 0.68,
      avg_liability_incidents_sdm_vs_guardianship_ratio: 0.92,
      pct_orgs_expanded_after_pilot: 0.73,
    },
  },
  {
...
const BIAS_TYPES = [
  "Recency Bias", "Halo Effect", "Anchoring", "Status Quo Bias",
  "Loss Aversion", "Optimism Bias", "Availability Bias", "Sunk Cost Fallacy",
  "Confirmation Bias", "Groupthink", "Concrete vs. Abstract Bias",
  "Endowment Effect", "Risk Aversion as Disguised Paternalism"
];
